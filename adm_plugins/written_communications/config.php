...
$plg_wc_roleArray = array('Administrator', 'Vorstand');

if(hasRole('Administrator') || hasRole('Vorstand'))
{
   $moduleMenu->addItem('written_communications','/adm_plugins/written_communications/written_communications.php','Briefe', '/icons/page_white_word.png');
}
